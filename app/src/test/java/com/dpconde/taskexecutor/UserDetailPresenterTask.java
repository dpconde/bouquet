...
import com.dpconde.taskexecutor.mvp.data.model.Location;
import com.dpconde.taskexecutor.mvp.data.model.Name;
...
public class UserDetailPresenterTask {

    private UserDetailPresenter.View mMockView;
    private TestDataManager mMockUserDataManager;
    ...
    public void setup() {
        ...
        mMockUserDataManager = mock(TestDataManager.class);
