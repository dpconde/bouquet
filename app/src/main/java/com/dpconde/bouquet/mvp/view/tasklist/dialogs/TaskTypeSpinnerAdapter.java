...
public class TaskTypeSpinnerAdapter extends ArrayAdapter<TaskType> {

    // Your sent context
    private Context context;
    // Your custom values for the spinner (User)
    private List<TaskType> values;

    public TaskTypeSpinnerAdapter(Context context, int textViewResourceId,
